...
export function CreatorSkillsDialog({ open, onOpenChange, activeSkillIds, onToggle }: CreatorSkillsDialogProps) {
  return (
        ...
        <div className="max-h-[56vh] space-y-2 overflow-y-auto">
          {SKILLS.map((s) => {
            ...
            return (
              ...
              >
                <Checkbox checked={checked} onCheckedChange={() => onToggle(s.id)} className="mt-0.5" />
