...
export function resolvePluginRuntime(plugin: Pick<LoadedPlugin, 'files' | 'manifest' | 'runtime_type'>): PluginRuntimeType {
  return runtimeFromManifestObject(plugin.manifest)
