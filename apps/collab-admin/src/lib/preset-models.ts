...
export const PRESET_MODELS: Record<string, PresetModel[]> = {
  ...
  anthropic: [
    ...
    { id: 'claude-opus-4-8', label: 'Claude Opus 4.8', contextWindow: 1000000, supportsReasoning: true },
    { id: 'claude-sonnet-4-6', label: 'Claude Sonnet 4.6', contextWindow: 1000000, supportsReasoning: true },
    { id: 'claude-haiku-4-5', label: 'Claude Haiku 4.5', contextWindow: 1000000 },
    // 前代（别名兼容）
    { id: 'claude-opus-4-7', label: 'Claude Opus 4.7', contextWindow: 1000000, supportsReasoning: true },
    { id: 'claude-opus-4-6', label: 'Claude Opus 4.6', contextWindow: 1000000, supportsReasoning: true },
  ],
  azure: [
  ...
  deepseek: [
    ...
    { id: 'deepseek-v4-pro', label: 'DeepSeek V4 Pro', contextWindow: 128000, supportsReasoning: true },
  ...
  moonshot: [
    ...
    { id: 'kimi-k2.7-code', label: 'Kimi K2.7 Code', contextWindow: 256000, supportsReasoning: true },
  ...
  qwen: [
    ...
    { id: 'qwen3.7-max-preview', label: 'Qwen3.7 Max Preview', contextWindow: 262144, supportsReasoning: true },
