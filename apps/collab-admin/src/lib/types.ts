export type View = 'dashboard' | 'users' | 'platformAdmins' | 'teams' | 'governance' | 'marketplaceCommerce' | 'audit' | 'settings' | 'releases' | 'roles' | 'pools' | 'channels' | 'billing' | 'credits' | 'callLogs' | 'tickets';
