...
import { assertIanaTimeZone, nextRecurringOccurrence, parseLocalTime, scheduleOccurrenceKey } from './automation-schedule-time';
...
describe('automation schedule wall-clock time', () => {
  ...
  it('uses ISO weekday and stable generation-scoped occurrence keys', () => {
    ...
    expect(scheduleOccurrenceKey('schedule-1', 3, next)).toBe('schedule-1:g3:2026-07-20T10:00:00.000Z');
  });
});
