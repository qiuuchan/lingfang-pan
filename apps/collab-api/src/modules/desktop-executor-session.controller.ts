...
@ApiTags('DesktopExecutorSessions') @ApiBearerAuth() @Controller('api/workflows/desktop-executor-sessions')
export class DesktopExecutorSessionController {
  constructor(@Inject(DesktopExecutorSessionService) private readonly sessions: DesktopExecutorSessionService) {}
