...
源码：`apps/collab-api/src/modules/plugin-action-registry.controller.ts`
...
| 方法 | 路径 | 处理器 |
|---|---|---|
| `GET` | `/api/api/plugin-releases/:releaseId/actions` | `list()` |
| `POST` | `/api/api/plugin-actions/resolve` | `resolve()` |
