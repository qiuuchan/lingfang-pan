...
源码：`apps/collab-api/src/modules/web-marketplace/web-preview-asset.controller.ts`

控制器基路径：`/api/internal/plugin-preview`
...
| 方法 | 路径 | 处理器 |
|---|---|---|
| `GET` | `/api/internal/plugin-preview/sessions/:sessionId/asset` | `asset()` |
