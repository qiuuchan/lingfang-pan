...
控制器基路径：`/api/admin/plugin-packages`
...
| 方法 | 路径 | 处理器 |
|---|---|---|
| `GET` | `/api/admin/plugin-packages` | `list()` |
| `GET` | `/api/admin/plugin-packages/:id` | `detail()` |
| `GET` | `/api/admin/plugin-packages/:id/releases` | `releases()` |
| `POST` | `/api/admin/plugin-packages/:id/delist` | `delist()` |
| `POST` | `/api/admin/plugin-packages/:id/relist` | `relist()` |
