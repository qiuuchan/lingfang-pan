...
源码：`apps/collab-api/src/modules/applications.controller.ts`

控制器基路径：`/api/team-admin-applications`
...
| 方法 | 路径 | 处理器 |
|---|---|---|
| `POST` | `/api/team-admin-applications` | `submit()` |
| `GET` | `/api/team-admin-applications/me` | `mine()` |
