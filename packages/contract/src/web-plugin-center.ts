...
export const WebPreviewSession = z.object({
...
export const WebCloudTrialCreateRequest = z.object({
  release_id: z.string().uuid(),
  release_sha256: Sha256Hex,
...
export const WebCloudPreviewAction = z.object({
  action_id: ActionId,
...
export const WebCloudTrialProjection = z.object({
  ...
  error: z.object({ code: z.string().trim().min(1).max(128), message: z.string().max(1000) }).strict().nullable(),
...
export const WebPluginCompatibility = z.object({
...
export const PublicPluginCard = z.object({
...
export const WebPluginCatalogQuery = z.object({
...
export const PublicPluginCatalogPage = z.object({
