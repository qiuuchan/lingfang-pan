...
export const AdminPaginationMetadata = z.object({
...
export const TeamAdminApplicationSummary = z.object({
  id: z.string().uuid(),
...
export const TeamAdminApplicationDetailResponse = z.object({
