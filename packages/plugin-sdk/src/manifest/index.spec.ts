...
import summarizerManifest from '../../../../plugins/summarizer/manifest.json';
import aiDemoManifest from '../../../../plugins/ai-demo/manifest.json';
import videodlManifest from '../../../../plugins/videodl/manifest.json';
import aiExampleManifest from '../../../../apps/desktop/builtin-plugins/ai-example/manifest.json';
import aiPythonExampleManifest from '../../../../apps/desktop/builtin-plugins/ai-python-example/manifest.json';
...
describe('validateManifest — 现有插件必须全部通过', () => {
  const existingPlugins: Array<{ name: string; manifest: unknown }> = [
    { name: 'summarizer', manifest: summarizerManifest },
    { name: 'ai-demo', manifest: aiDemoManifest },
    { name: 'videodl', manifest: videodlManifest },
    { name: 'ai-example', manifest: aiExampleManifest },
    { name: 'ai-python-example', manifest: aiPythonExampleManifest },
